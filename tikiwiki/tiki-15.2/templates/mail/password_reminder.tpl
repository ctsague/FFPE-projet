{* $Id: password_reminder.tpl 58603 2016-05-16 11:16:41Z eromneg $ *}{tr}Hi{/tr} {$mail_user},

{tr}Someone {/tr} {if $clearpw eq 'y'}{tr}requested a reminder of the password for your {$prefs.mail_template_custom_text}account{/tr}{else}{tr}requested a password reset for your {$prefs.mail_template_custom_text}account{/tr} {/if} ({$mail_site}).

{if $clearpw eq 'y'}
	{tr}Since this is your registered email address this is to let you know that the password for this account is {/tr} {$mail_pass}
{else}
