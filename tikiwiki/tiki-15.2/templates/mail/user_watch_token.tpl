{* $Id: user_watch_token.tpl 58610 2016-05-17 14:28:41Z eromneg $ *}<a href="mailto:{$email_token}">{$email_token}</a> {tr}has consulted your{/tr} {$prefs.mail_template_custom_text}
