{* $Id: user_watch_map_changed.tpl 58609 2016-05-17 14:13:02Z eromneg $ *}{tr}The {$prefs.mail_template_custom_text}map {$mail_page} was changed by {$mail_user|username} at {$mail_date|tiki_short_datetime:"":"n"}{/tr}
