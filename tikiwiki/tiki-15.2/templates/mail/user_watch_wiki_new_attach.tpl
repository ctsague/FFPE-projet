{* $Id: user_watch_wiki_new_attach.tpl 58610 2016-05-17 14:28:41Z eromneg $ *}{tr}A new file has been attached to {$prefs.mail_template_custom_text}page{/tr} {$mail_page|sefurl} {tr}by{/tr} {$mail_user|username}.
