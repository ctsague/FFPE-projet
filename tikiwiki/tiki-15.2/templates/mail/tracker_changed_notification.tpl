{* $Id: tracker_changed_notification.tpl 58604 2016-05-16 11:56:52Z eromneg $ *}{if $mail_action eq 'deleted'}{tr}ItemID {$mail_itemId} {$mail_item_desc} was deleted in the {$prefs.mail_template_custom_text}tracker {tr}{$mail_trackerName}{/tr}{/tr}
