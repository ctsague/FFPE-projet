...
"Path" => "Path/Rod",
"Register" => "Register",
"The file has incorrect syntax or is not a CSV file" => "Disfala file hemi no wanfala CSV file o mitabe hemi no stret long syntax blong hem",
"refresh" => "refresh",
...
"Preview" => "Preview",
"You don't have permission to upload zipped file packages" => "Tambu fo upload olketa file pasel wea olketa i bin zipim",
"Browse" => "Browse",
"Merge" => "Merge",
"locked" => "lokem",
...
"User profile picture" => "Avatar blong user",
"Posts" => "Olketa Post",
"Visits" => "Visitim",
"Activity" => "Activity",
"Year" => "Year",
...
"The linked-to website can be opened in various ways" => "Wei fo openem olketa directory link",
"Replace the current window" => "senisimbaek disfala windo",
"Open a new window" => "niu windo",
"Open an iframe" => "Open an iframe",
"days" => "olketa dei",
"Default number of comments per page" => "Default namba long olketa toktok long wanfala pej",
"Default order of comments" => "Default order long olketa toktok",
"Blog" => "Blog",
"Polls" => "Olketa Poll",
...
"Use folder icons for menu section (parent) items" => "Som olketa menu olsem olketa folder",
"Activate" => "Activate",
...
"Always display modules to all groups" => "Som olketa module go long evri grup evritaem",
...
"Send me an email for messages with priority equal to or greater than" => "Sendem kam wanfala email fo olketa mesij wea priority blong olketa hemi equal long o hemi bik winin",
...
"Allow viewing HTML emails?" => "Hao, baebae letem fo lukluk long olketa HTML mel?",
...
"Most-visited forums" => "Olketa forum blong olketa forum wea olketa i bin visitim olowe",
...
"Wiki most-recent images" => "Olketa las image blong Wiki",
"Upload date" => "Uploadem date",
"Wiki most-recent files" => "Olketa las file blong Wiki",
...
"Log In" => "Log In",
"Send a message" => "Sendem mesij",
"Attach a file" => "Attachem file",
"Gallery" => "Gallery",
"Article" => "Article",
"Blog post" => "Blog post",
"comment" => "toktok",
...
"Custom location" => "Olketa kastom Location",
"Custom language" => "Olketa kastom Langguis",
"Custom priority" => "Olketa Kastom Priority",
...
"Forward messages to this forum to this email address, in a format that can be used for sending back to the inbound forum email address" => " Iu save forwardem kam eni mesij long disfala forum long disfala email adres, an iu mas iusim wanfala format wea hemi isi fo save sendem go baek long disfala email adres wea iu putim kam long forum",
"Originating email address for mails from this forum" => "Olketa email adres blong olketa email from disfala forum",
...
"Child type" => "Pikinini type",
"Maximum number of child directory categories to show" => "Maximum namba blong olketa pikinini fo som",
...
"Popular Sites" => "Olketa cool site",
"any" => "eni",
...
"Client" => "Client",
"Maximum impressions" => "Olketa Max impression",
...
"Remove zones (info entered for any banner in the zones will be lost)" => "Tekaotem olketa Zones (baebae iu lusim olketa info blong disfala banner)",
"Edit Blog" => "Mekem senis long Blog",
"Individual permissions are set for this blog" => "Disfala blog hemi garem olketa individual permission wea hemi bin set finis",
...
"Important" => "Important",
"The Sandbox is a page where you can practice editing, etc. and use the preview feature to check the appearance of the page. No versions are stored for this page." => "Disfala SandBox hemi wanfala pej wea iu save practicem olketa skill blong iu long hao fo mekem senis,iusim disfala preview feature fo lukim fastaem lukluk blong disfala pej, no eni version hemi bin stoarem fo disfala pej.",
...
"Discuss" => "Discuss",
"version" => "version",
"Pick your profile picture" => "Pick wanfala avatar fo iu",
"Your current profile picture" => "Disfala avatar blong iu",
"Pick user profile picture" => "Pikim wanfala user Avatar",
"Hide all" => "Haedem evriwan",
"Show all" => "Som evriwan",
"random" => "random",
"Upload your own profile picture" => "Upload avatar blong iu seleva",
...
"The page cannot be edited because it is locked" => "Had fo mekem senis long disfala pej bikos hemi lokem",
"Most-visited file galleries" => "Olketa top file gallery wea olketa i bin visitim hem",
"Most downloaded files" => "Olketa file wea olketa save download olowe nomoa",
"Last files" => "Olketa las file",
"No gallery ID specified" => "Iu mas givim wanfala nem o namba fo galleryId",
...
"The file is too large" => "File hemi big tumas",
...
"The quiz time limit was exceeded. The quiz score cannot be computed" => "Hemi ovam finis quiz taem so baebae no save talem kam quiz",
...
"Cannot upload this file. The storage quota would be exceeded" => "Baebae no save uploadem disfala file bikos no garem enav spes/quota",
...
"You do not have permission to remove someone else's post!" => "Tambu fo iu tekaotem post blong olketa narafala man!",
