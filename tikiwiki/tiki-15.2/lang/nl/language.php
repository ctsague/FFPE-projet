...
"On \"Permission denied\", display the log-in module (for anonymous users)" => "Bij geen toegangsrechten toon de aanmeldmodule (voor Anoniemen)",
...
"Close the site (except for those with access permission)" => "Sluit de site (behalve voor diegenen met rechten)",
"After" => "Na",
"Before" => "Voor",
...
"HTML \"alt\" tag description (for text browsers, screen readers, etc.)" => "Alt. beschrijving (e.g. voor tekst browsers)",
"Modified" => "Gewijzigd",
