...
"Do not start messages titles with 'Re: '" => "Não adicione prefixo em mensagens com titulo 'Re: '",
...
"Close the site (except for those with access permission)" => "Fechar site (exceto para aqueles com permissão)",
...
"HTML \"alt\" tag description (for text browsers, screen readers, etc.)" => "Descrição alternativa (ex: para navegadores modo texto",
"Modified" => "Modificado",
...
"Close the site when the server load is above the threshold (except for users with closed-site access permission)" => "Fechar site quando a carga do servidor estiver além do limite (exceto para aqueles com permissão)",
