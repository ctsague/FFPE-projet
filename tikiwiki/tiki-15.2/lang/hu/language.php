...
"Blog" => "Blog",
"Limit categorization to within the subtree of" => "Kategorizálás kényszerítése és korlátozása ezen kategóriaág alá",
...
"Use File Galleries to store images" => "Képek tárolása fájlgalériában",
...
"Dumps" => "Dump-ok",
"Display before headings an icon to show or hide the content that follows the headings" => "Megjelenítés/elrejtés ikon megjelenítése címsorok előtt",
...
"Do not start messages titles with 'Re: '" => "Az üzenetek ne kapjanak 'Re:' előtagot",
...
"HTML DOM Elements to be fixed" => "Fixálandó HTMLDomElements",
"Fade" => "Előtűnés",
...
"On \"Permission denied\", display the log-in module (for anonymous users)" => "Jogosultság hiány esetén a bejelentkezési  modul megjelenítése anonim felhasználóknak",
...
"Tiki can post to the Facebook Wall" => "Tiki posztolhat az üzenőfalra",
...
"Close the site when the server load is above the threshold (except for users with closed-site access permission)" => "Weblap lezárása ha a szerver leterheltsége a küszöb felett van (a megfelelő jogosultsággal rendelkezők továbbra is beléphetnek)",
...
"Number of days to consider in displaying \"who viewed my items\"" => "A megtekintéseknél figyelembe veendő napok száma",
...
"Limit categorization to within the subtree of:" => "Kategorizálás erőltetése és korlátozása ezen alkategóriákra:",
