...
"Path" => "路徑",
"Register" => "註冊",
"The file has incorrect syntax or is not a CSV file" => "檔案不是 CSV 檔, 或是語法錯誤",
"refresh" => "更新",
"Administration" => "系統管理",
"Sunday" => "星期日",
"Monday" => "星期一",
...
"Preview" => "預覽",
"You don't have permission to upload zipped file packages" => "沒有權限上傳 zip 壓縮的檔案包",
"Browse" => "瀏覽",
"Merge" => "合併",
"Move" => "移動",
"locked" => "鎖定",
...
"The linked-to website can be opened in various ways" => "打開目錄連結的方法",
"Replace the current window" => "取代目前視窗",
"Open a new window" => "新的視窗",
"Open an iframe" => "行內頁框",
"days" => "日",
"Default number of comments per page" => "預設每頁評論數目",
"Default order of comments" => "預設評論排序",
"Blog" => "Blog",
"Polls" => "測驗紀錄",
"Newsletters" => "電子報",
"Calendar" => "行事曆",
...
"Use folder icons for menu section (parent) items" => "用資料夾方式顯示選單",
"Activate" => "啟動",
"Submissions" => "提交",
"Rankings" => "排名",
"Print" => "列印",
...
"Topics (desc)" => "主題 (降冪)",
"Threads (desc)" => "討論串 (降冪)",
"Latest post (desc)" => "最近發表佈告 (降冪)",
"Name (desc)" => "名稱 (降冪)",
"Name (asc)" => "名稱 (升冪)",
"Browser title" => "瀏覽器標題",
"Temporary directory" => "暫存目錄",
"Open external links in new window" => "於新視窗開啟外部連結",
"Always display modules to all groups" => "所有的群組都顯示模組",
...
"Send me an email for messages with priority equal to or greater than" => "發送 email 通知, 當訊息重要性大於等於",
"My pages" => "我的頁面",
"My blogs" => "我的 blogs",
"My galleries" => "我的圖庫",
"My messages" => "我的訊息",
"My tasks" => "我的工作",
"My items" => "我的事項",
"Allow viewing HTML emails?" => "允許閱讀 HTML 郵件?",
"Maximum size for each attachment" => "每個附件的最大大小",
"Unlimited" => "未限制",
"Complete" => "Complete",
"no cache" => "無快取",
"minute" => "分",
"Page creators are administrators of their pages" => "頁面建立者也是頁面管理者",
...
"Downloads" => "下傳數",
"Wiki most-recent images" => "Wiki 最新影像",
"Upload date" => "上傳日期",
"Wiki most-recent files" => "Wiki 最新檔案",
"Top Articles" => "最熱門文章",
...
"Custom language" => "自訂語系",
"Custom priority" => "自訂重要性",
...
"Child type" => "子型別",
"Maximum number of child directory categories to show" => "最大展示的分類數目",
"Editor group" => "編輯者群組",
"cType" => "cType",
"allow" => "允許",
"count" => "次",
...
"Edit Blog" => "編輯 Blog",
"Individual permissions are set for this blog" => "這個 blog 有獨立的權限設定",
"Allow search" => "允許搜尋",
"Allow comments" => "允許評論",
...
"Discuss" => "討論",
"version" => "版本",
"Pick your profile picture" => "選擇你的頭像",
"Your current profile picture" => "你目前的頭像",
"Pick user profile picture" => "選擇使用者的頭像",
"Hide all" => "隱藏全部",
"Show all" => "顯示全部",
"random" => "隨機",
"Upload your own profile picture" => "上傳你自己的頭像",
"Vote poll" => "投票",
"Other Polls" => "其他投票",
"votes" => "票",
...
"The page cannot be edited because it is locked" => "無法編輯頁面, 它正被鎖定中",
"Most-visited file galleries" => "最常被瀏覽圖庫",
...
"Unknown user" => "不明使用者",
"Cannot upload this file. The storage quota would be exceeded" => "無法上傳檔案, 磁碟配額不足",
