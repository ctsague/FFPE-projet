...
"Detected, Version" => "اكتشفت، اصدار",
"Test Image" => "صورة اختبار",
"Not detected" => "لم تكتشف",
"Unknown" => "غير معروف",
...
"%d user-group assignments" => "تعيينات في مجموعة المستخدمين %d",
"Used" => "مستخدم",
"Available" => "متوفر",
"Memory" => "ذاكرة",
"Hit" => "زيارة",
"Miss" => "ضائع",
"Cache" => "تخزين مؤقت",
"New configuration created (id %0)" => "(id %0) تهيئة جديدة أنشئت",
"Configuration updated" => "تهيئة محدثة",
...
"Tag not found" => "لم يتم العثور على هذا الوصف",
"Re:" => "رد:",
