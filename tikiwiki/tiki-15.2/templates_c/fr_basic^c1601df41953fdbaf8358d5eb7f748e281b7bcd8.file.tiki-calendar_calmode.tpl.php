<?php /* Smarty version Smarty-3.1.21, created on 2016-11-30 11:19:19
         compiled from "/home/ctsague/exos/projet_ffpe/tikiwiki/tiki-15.2/templates/tiki-calendar_calmode.tpl" */ ?>
<?php /*%%SmartyHeaderCode:979605349583eb5b7b28472-43209672%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c1601df41953fdbaf8358d5eb7f748e281b7bcd8' => 
    array (
      0 => '/home/ctsague/exos/projet_ffpe/tikiwiki/tiki-15.2/templates/tiki-calendar_calmode.tpl',
      1 => 1453695838,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '979605349583eb5b7b28472-43209672',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_583eb5b7e174d9_53694315',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_583eb5b7e174d9_53694315')) {function content_583eb5b7e174d9_53694315($_smarty_tpl) {?><?php if (!is_callable('smarty_function_cycle')) include '/home/ctsague/exos/projet_ffpe/tikiwiki/tiki-15.2/vendor/smarty/smarty/libs/plugins/function.cycle.php';
...
" title="Afficher cette semaine"><?php echo $_smarty_tpl->tpl_vars['weekNumbers']->value[$_smarty_tpl->getVariable('smarty')->value['section']['w']['index']];?>
</a></td>
...
" title="Changer le focus" style="font-size:11px">
...
}?>" title=":Ajouter un évènement" class="addevent tips">
...
;opacity:<?php if ($_smarty_tpl->tpl_vars['cell']->value[$_smarty_tpl->getVariable('smarty')->value['section']['w']['index']][$_smarty_tpl->getVariable('smarty')->value['section']['d']['index']]['items'][$_smarty_tpl->getVariable('smarty')->value['section']['item']['index']]['status']=='0') {?>0.8<?php } else { ?>1<?php }?>;filter:Alpha(opacity=<?php if ($_smarty_tpl->tpl_vars['cell']->value[$_smarty_tpl->getVariable('smarty')->value['section']['w']['index']][$_smarty_tpl->getVariable('smarty')->value['section']['d']['index']]['items'][$_smarty_tpl->getVariable('smarty')->value['section']['item']['index']]['status']=='0') {?>80<?php } else { ?>100<?php }?>);text-align:left;border-width:1px <?php if ($_smarty_tpl->tpl_vars['cell']->value[$_smarty_tpl->getVariable('smarty')->value['section']['w']['index']][$_smarty_tpl->getVariable('smarty')->value['section']['d']['index']]['items'][$_smarty_tpl->getVariable('smarty')->value['section']['item']['index']]['endTimeStamp']<=($_smarty_tpl->tpl_vars['cell']->value[$_smarty_tpl->getVariable('smarty')->value['section']['w']['index']][$_smarty_tpl->getVariable('smarty')->value['section']['d']['index']]['day']+86400)) {?>1<?php } else { ?>0<?php }?>px 1px <?php if ($_smarty_tpl->tpl_vars['cell']->value[$_smarty_tpl->getVariable('smarty')->value['section']['w']['index']][$_smarty_tpl->getVariable('smarty')->value['section']['d']['index']]['items'][$_smarty_tpl->getVariable('smarty')->value['section']['item']['index']]['startTimeStamp']>=$_smarty_tpl->tpl_vars['cell']->value[$_smarty_tpl->getVariable('smarty')->value['section']['w']['index']][$_smarty_tpl->getVariable('smarty')->value['section']['d']['index']]['day']) {?>1<?php } else { ?>0<?php }?>px;cursor:pointer"
												<?php if ($_smarty_tpl->tpl_vars['prefs']->value['calendar_sticky_popup']=='y') {?>
													<?php echo smarty_function_popup(array('caption'=>"Évènement",'vauto'=>true,'hauto'=>true,'sticky'=>true,'fullhtml'=>"1",'trigger'=>"onClick",'text'=>smarty_modifier_escape(smarty_modifier_escape($_smarty_tpl->tpl_vars['over']->value,"javascript"),"html")),$_smarty_tpl);?>

												<?php } else { ?>
													<?php echo smarty_function_popup(array('caption'=>"Évènement",'vauto'=>true,'hauto'=>true,'sticky'=>false,'fullhtml'=>"1",'text'=>smarty_modifier_escape(smarty_modifier_escape($_smarty_tpl->tpl_vars['over']->value,"javascript"),"html")),$_smarty_tpl);?>
