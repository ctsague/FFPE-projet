<?php /* Smarty version Smarty-3.1.21, created on 2016-11-30 09:58:59
         compiled from "/home/ctsague/exos/projet_ffpe/tikiwiki/tiki-15.2/templates/header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2052652624583ea2e3a2a1f7-82057381%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cf511e10f65e5ba74135e1a0fa9ad746ca30d221' => 
    array (
      0 => '/home/ctsague/exos/projet_ffpe/tikiwiki/tiki-15.2/templates/header.tpl',
      1 => 1466343496,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2052652624583ea2e3a2a1f7-82057381',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_583ea2e424b250_61939189',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_583ea2e424b250_61939189')) {function content_583ea2e424b250_61939189($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/home/ctsague/exos/projet_ffpe/tikiwiki/tiki-15.2/lib/smarty_tiki/modifier.truncate.php';
if (!is_callable('smarty_modifier_tr_if')) include '/home/ctsague/exos/projet_ffpe/tikiwiki/tiki-15.2/lib/smarty_tiki/modifier.tr_if.php';
...
<?php } elseif (isset($_smarty_tpl->tpl_vars['galleryId']->value)&&$_smarty_tpl->tpl_vars['galleryId']->value!=''&&$_smarty_tpl->tpl_vars['prefs']->value['metatag_imagetitle']!='n') {?>
	<meta name="keywords" content="Galeries d'images <?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['title']->value);?>
 <?php if ($_smarty_tpl->tpl_vars['prefs']->value['feature_freetags']=='y') {
$_smarty_tpl->tpl_vars['taginfo'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['taginfo']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['freetags']->value['data']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['taginfo']->key => $_smarty_tpl->tpl_vars['taginfo']->value) {
...
<?php if (isset($_smarty_tpl->tpl_vars['section']->value)&&$_smarty_tpl->tpl_vars['section']->value=="blogs") {?>
	<?php if (empty($_smarty_tpl->tpl_vars['blog_data']->value['title'])) {?>
	<meta name="description" content="Blog listing" property="og:description">
	<meta name="twitter:description" content="Blog listing">
	<?php } elseif (empty($_smarty_tpl->tpl_vars['postId']->value)) {?>
	<meta name="description" content="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['blog_data']->value['title']);?>
" property="og:description">
	<meta name="twitter:description" content="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['blog_data']->value['title']);?>
">
	<?php } else { ?>
	<meta name="description" content="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['post_info']->value['title']);?>
 - <?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['blog_data']->value['title']);?>
" property="og:description">
	<meta name="twitter:description" content="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['post_info']->value['title']);?>
 - <?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['blog_data']->value['title']);?>
">
	<?php }?>
<?php } elseif (isset($_smarty_tpl->tpl_vars['section']->value)&&$_smarty_tpl->tpl_vars['section']->value=="cms") {?>
	...
	<?php if ($_smarty_tpl->tpl_vars['heading']->value!='') {?>
		<meta name="description" content="<?php echo smarty_modifier_escape(smarty_modifier_truncate($_smarty_tpl->tpl_vars['heading']->value,150));?>
" property="og:description">
		<meta name="twitter:description" content="<?php echo smarty_modifier_escape(smarty_modifier_truncate($_smarty_tpl->tpl_vars['heading']->value,150));?>
">
	<?php } elseif ($_smarty_tpl->tpl_vars['body']->value!='') {?>
		<meta name="description" content="<?php echo smarty_modifier_escape(smarty_modifier_truncate($_smarty_tpl->tpl_vars['body']->value,150));?>
" property="og:description">
		<meta name="twitter:description" content="<?php echo smarty_modifier_escape(smarty_modifier_truncate($_smarty_tpl->tpl_vars['body']->value,150));?>
">
	<?php } elseif (empty($_smarty_tpl->tpl_vars['prefs']->value['metatag_description'])) {?>
		<meta name="description" content="Articles listing at <?php echo smarty_modifier_escape(smarty_modifier_tr_if($_smarty_tpl->tpl_vars['prefs']->value['browsertitle']));?>
" property="og:description">
		<meta name="twitter:description" content="Articles listing at <?php echo smarty_modifier_escape(smarty_modifier_tr_if($_smarty_tpl->tpl_vars['prefs']->value['browsertitle']));?>
">
	<?php } else { ?>
		<meta name="description" content="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['prefs']->value['metatag_description']);?>
" property="og:description">
		<meta name="twitter:description" content="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['prefs']->value['metatag_description']);?>
">
	<?php }?>
<?php } elseif ($_smarty_tpl->tpl_vars['prefs']->value['metatag_pagedesc']=='y'&&!empty($_smarty_tpl->tpl_vars['description']->value)) {?>
	<meta name="description" content="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['description']->value);?>
" property="og:description">
	<meta name="twitter:description" content="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['description']->value);?>
">
<?php } elseif (!empty($_smarty_tpl->tpl_vars['prefs']->value['metatag_description'])) {?>
	<meta name="description" content="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['prefs']->value['metatag_description']);?>
" property="og:description">
...
if ($_smarty_tpl->tpl_vars['hasImage']->value=='y') {?>article_image.php?image_type=article&amp;id=<?php echo $_smarty_tpl->tpl_vars['articleId']->value;
	...
	<?php } else { ?>
		<meta content="<?php echo $_smarty_tpl->tpl_vars['prefs']->value['socialnetworks_facebook_site_image'];?>
" property="og:image">
...
<?php if ($_smarty_tpl->tpl_vars['prefs']->value['site_favicon']) {?>
	<link rel="icon" href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['prefs']->value['site_favicon']);?>
">
<?php }?>
...
<?php if ((isset($_smarty_tpl->tpl_vars['editable']->value)&&$_smarty_tpl->tpl_vars['editable']->value)&&($_smarty_tpl->tpl_vars['tiki_p_edit']->value=='y'||mb_strtolower($_smarty_tpl->tpl_vars['page']->value, 'UTF-8')=='sandbox'||$_smarty_tpl->tpl_vars['tiki_p_admin_wiki']->value=='y')) {?>
	<link rel="alternate" type="application/x-wiki" title="Éditer cette page !" href="tiki-editpage.php?page=<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['page']->value,'url');?>
">
<?php }?>
...
<?php if ($_smarty_tpl->tpl_vars['prefs']->value['feature_blogs']=='y'&&$_smarty_tpl->tpl_vars['prefs']->value['feed_blogs']=='y'&&$_smarty_tpl->tpl_vars['tiki_p_read_blog']->value=='y') {?>
	<link rel="alternate" type="application/rss+xml" title='<?php echo (($tmp = @smarty_modifier_escape($_smarty_tpl->tpl_vars['prefs']->value['feed_blogs_title']))===null||$tmp==='' ? "RSS Blogues" : $tmp);?>
...
<?php if ($_smarty_tpl->tpl_vars['prefs']->value['feature_galleries']=='y'&&$_smarty_tpl->tpl_vars['prefs']->value['feed_image_galleries']=='y'&&$_smarty_tpl->tpl_vars['tiki_p_view_image_gallery']->value=='y') {?>
	<link rel="alternate" type="application/rss+xml" title='<?php echo (($tmp = @smarty_modifier_escape($_smarty_tpl->tpl_vars['prefs']->value['feed_image_galleries_title']))===null||$tmp==='' ? "RSS Galeries d'images" : $tmp);?>
...
<?php if ($_smarty_tpl->tpl_vars['prefs']->value['feature_file_galleries']=='y'&&$_smarty_tpl->tpl_vars['prefs']->value['feed_file_galleries']=='y'&&$_smarty_tpl->tpl_vars['tiki_p_view_file_gallery']->value=='y') {?>
	<link rel="alternate" type="application/rss+xml" title='<?php echo (($tmp = @smarty_modifier_escape($_smarty_tpl->tpl_vars['prefs']->value['feed_file_galleries_title']))===null||$tmp==='' ? "Flux RSS Galeries de fichiers" : $tmp);?>
...
<?php if ($_smarty_tpl->tpl_vars['prefs']->value['feature_directory']=='y'&&$_smarty_tpl->tpl_vars['prefs']->value['feed_directories']=='y'&&$_smarty_tpl->tpl_vars['tiki_p_view_directory']->value=='y') {?>
	<link rel="alternate" type="application/rss+xml" title='<?php echo (($tmp = @smarty_modifier_escape($_smarty_tpl->tpl_vars['prefs']->value['feed_directories_title']))===null||$tmp==='' ? "RSS Répertoires" : $tmp);?>
...
<?php if ($_smarty_tpl->tpl_vars['prefs']->value['feature_calendar']=='y'&&$_smarty_tpl->tpl_vars['prefs']->value['feed_calendar']=='y'&&$_smarty_tpl->tpl_vars['tiki_p_view_calendar']->value=='y') {?>
	<link rel="alternate" type="application/rss+xml" title='<?php echo (($tmp = @smarty_modifier_escape($_smarty_tpl->tpl_vars['prefs']->value['feed_calendar_title']))===null||$tmp==='' ? "Calendriers RSS" : $tmp);?>
...
<!--[if lt IE 9]>
	<?php echo '<script'; ?>
 src="vendor/afarkas/html5shiv/dist/html5shiv.min.js" type="text/javascript"><?php echo '</script'; ?>
>
<![endif]-->
