<?php /* Smarty version Smarty-3.1.21, created on 2016-11-30 11:19:19
         compiled from "/home/ctsague/exos/projet_ffpe/tikiwiki/tiki-15.2/templates/tiki-calendar.tpl" */ ?>
<?php /*%%SmartyHeaderCode:221327192583eb5b7553209-32124888%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd4026063a6756649294978ce82c966b8e0827b90' => 
    array (
      0 => '/home/ctsague/exos/projet_ffpe/tikiwiki/tiki-15.2/templates/tiki-calendar.tpl',
      1 => 1458234347,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '221327192583eb5b7553209-32124888',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_583eb5b7882938_85444474',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_583eb5b7882938_85444474')) {function content_583eb5b7882938_85444474($_smarty_tpl) {?><?php if (!is_callable('smarty_block_title')) include '/home/ctsague/exos/projet_ffpe/tikiwiki/tiki-15.2/lib/smarty_tiki/block.title.php';
...
if (!is_callable('smarty_function_jscalendar')) include '/home/ctsague/exos/projet_ffpe/tikiwiki/tiki-15.2/lib/smarty_tiki/function.jscalendar.php';
...
if (!is_callable('smarty_function_js_insert_icon')) include '/home/ctsague/exos/projet_ffpe/tikiwiki/tiki-15.2/lib/smarty_tiki/function.js_insert_icon.php';
?>
...
<?php $_smarty_tpl->smarty->_tag_stack[] = array('title', array('admpage'=>"calendar")); $_block_repeat=true; echo smarty_block_title(array('admpage'=>"calendar"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
	...
	<?php if (count($_smarty_tpl->tpl_vars['displayedcals']->value)==1) {?>
		Calendrier: <?php $_smarty_tpl->tpl_vars['x'] = new Smarty_variable($_smarty_tpl->tpl_vars['displayedcals']->value[0], null, 0);
...
" hspace="1">
 ...
 Surveillance de groupe
		...
		<?php if ($_smarty_tpl->tpl_vars['tiki_p_admin_calendar']->value=='y'||$_smarty_tpl->tpl_vars['tiki_p_admin']->value=='y') {?>
			<?php if (count($_smarty_tpl->tpl_vars['displayedcals']->value)==1) {?>
				<?php echo smarty_function_button(array('href'=>"tiki-admin_calendars.php?calendarId=".((string)$_smarty_tpl->tpl_vars['displayedcals']->value[0]),'_type'=>"link",'_text'=>"Éditer",'_icon_name'=>"edit"),$_smarty_tpl);?>

			<?php }?>
			<?php echo smarty_function_button(array('href'=>"tiki-admin_calendars.php?cookietab=1",'_type'=>"link",'_text'=>"Administrer",'_icon_name'=>"admin"),$_smarty_tpl);?>

		<?php }?>


		<?php if ($_smarty_tpl->tpl_vars['tiki_p_add_events']->value=='y') {?>
			<?php echo smarty_function_button(array('href'=>"tiki-calendar_edit_item.php",'_type'=>"link",'_text'=>"Ajouter un évènement",'_icon_name'=>"create"),$_smarty_tpl);?>

		<?php }?>

		<?php if ($_smarty_tpl->tpl_vars['tiki_p_view_events']->value=='y'&&$_smarty_tpl->tpl_vars['prefs']->value['calendar_export']=='y') {?>
			<?php echo smarty_function_button(array('href'=>"#",'_onclick'=>"toggle('exportcal');return false;",'_text'=>"Exporter",'_icon_name'=>"import"),$_smarty_tpl);?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
			...
			<?php echo smarty_function_button(array('href'=>Smarty::$_smarty_vars['capture']['href'],'_text'=>"Vue calendrier",'_icon_name'=>"calendar"),$_smarty_tpl);?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
			...
			<?php echo smarty_function_button(array('href'=>Smarty::$_smarty_vars['capture']['href'],'_text'=>"Vue en liste",'_icon_name'=>"list"),$_smarty_tpl);?>

		<?php }?>

		<?php if (count($_smarty_tpl->tpl_vars['listcals']->value)>=1) {?>
			<?php echo smarty_function_button(array('href'=>"#",'_onclick'=>"toggle('filtercal');return false;",'_text'=>"Calendriers visibles",'_icon_name'=>"eye"),$_smarty_tpl);?>
...
;" onclick="toggle('filtercal')"><?php echo $_smarty_tpl->tpl_vars['thisinfocalsname']->value;?>
			...
			<?php } else { ?>
				<?php echo smarty_function_button(array('href'=>'','_style'=>"background-color:#fff;padding:0 4px;",'_text'=>"Aucun"),$_smarty_tpl);?>
...
" name="f" style="display:none;">
			<div class="modal-header caltitle">Calendriers de groupe</div>
			<div class="modal-body">
				<div class="caltoggle">
					<?php echo smarty_function_select_all(array('checkbox_names'=>'calIds[]','label'=>"Cocher/décocher tout"),$_smarty_tpl);?>
...
">
					<input type="submit" class="btn btn-default btn-sm" name="refresh" value="Actualiser">
				</div>
			</div>
		</form>
	<?php }?>
...
" name="f" style="display:none;">
			...
			<div class="caltitle">Export de calendriers</div>
			<div class="caltoggle">
				<?php echo smarty_function_select_all(array('checkbox_names'=>'calendarIds[]','label'=>"Cocher/décocher tout"),$_smarty_tpl);?>
...
">paramètres avancés</a>
			...
			<div class="calinput">
				<input type="submit" class="btn btn-default btn-sm" name="ical" value="Exporter au format iCal">
				<input type="submit" class="btn btn-default btn-sm" name="csv" value="Exporter au format CSV">
			</div>
		</form>
	<?php }?>
...
,
				...
				monthNamesShort: [ "janv.", "févr.", "mars.", "avr.", "mai", "juin", "juillet", "août", "sept.", "oct.", "Nov.", "Dec."],
