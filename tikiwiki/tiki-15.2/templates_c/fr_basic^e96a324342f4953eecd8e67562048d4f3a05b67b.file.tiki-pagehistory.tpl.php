<?php /* Smarty version Smarty-3.1.21, created on 2016-11-30 14:58:44
         compiled from "/home/ctsague/exos/projet_ffpe/tikiwiki/tiki-15.2/templates/tiki-pagehistory.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1051842878583ee924a1abc6-71655649%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e96a324342f4953eecd8e67562048d4f3a05b67b' => 
    array (
      0 => '/home/ctsague/exos/projet_ffpe/tikiwiki/tiki-15.2/templates/tiki-pagehistory.tpl',
      1 => 1467640340,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1051842878583ee924a1abc6-71655649',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_583ee924c05c61_69899238',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_583ee924c05c61_69899238')) {function content_583ee924c05c61_69899238($_smarty_tpl) {?><?php if (!is_callable('smarty_block_title')) include '/home/ctsague/exos/projet_ffpe/tikiwiki/tiki-15.2/lib/smarty_tiki/block.title.php';
...
Historique: <?php echo $_smarty_tpl->tpl_vars['page']->value;
...
<div class="t_navbar margin-bottom-md">
	...
	<?php echo smarty_function_button(array('href'=>"tiki-index.php?page=".((string)$_smarty_tpl->tpl_vars['thispage']->value),'class'=>"btn btn-default",'_text'=>"Afficher la page",'_icon_name'=>"view"),$_smarty_tpl);?>

	<?php echo smarty_function_button(array('href'=>"tiki-editpage.php?page=".((string)$_smarty_tpl->tpl_vars['thispage']->value),'class'=>"btn btn-default",'_text'=>"Édition",'_icon_name'=>"edit"),$_smarty_tpl);?>
	...
	<?php if (!isset($_smarty_tpl->tpl_vars['noHistory']->value)) {?>
		...
		<?php } else { ?>
			<?php echo smarty_function_button(array('_text'=>"Montrer toutes les versions",'href'=>"?clear_versions=1&show_all_versions=y",'_auto_args'=>"*",'class'=>"btn btn-default",'_icon_name'=>"collapsed"),$_smarty_tpl);?>
...
<?php if ($_smarty_tpl->tpl_vars['preview']->value) {?>
	<h2>Aperçu de cette version: <?php echo $_smarty_tpl->tpl_vars['preview']->value;?>

		<?php if ($_smarty_tpl->tpl_vars['info']->value['version']==$_smarty_tpl->tpl_vars['preview']->value) {?><small><small>(courant)</small></small><?php }?>
	</h2>
...
$_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_pagination_links(array('cant'=>$_smarty_tpl->tpl_vars['ver_cant']->value,'offset'=>$_REQUEST['preview_idx'],'offset_arg'=>"preview_idx",'itemname'=>"Version",'show_numbers'=>"n"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
	...
	<?php if ((isset($_smarty_tpl->tpl_vars['flaggedrev_approval']->value)&&$_smarty_tpl->tpl_vars['flaggedrev_approval']->value)&&$_smarty_tpl->tpl_vars['tiki_p_wiki_approve']->value=='y') {?>
		<?php $_smarty_tpl->smarty->_tag_stack[] = array('remarksbox', array('type'=>'comment','title'=>"Approbation du Contenu")); $_block_repeat=true; echo smarty_block_remarksbox(array('type'=>'comment','title'=>"Approbation du Contenu"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
">
				<?php if ($_smarty_tpl->tpl_vars['flaggedrev_preview_approved']->value) {?>
					<p>Cette révision est actuellement marquée comme approuvée.<p>
					<div class="submit">
						<input type="hidden" name="unapprove" value="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['preview']->value);?>
">
						<input type="submit" class="btn btn-default btn-sm" name="flaggedrev" value="Retirer l'approbation">
					</div>
				<?php } else { ?>
					<p>Cette révision n'a pas été approuvée.<p>
					<div class="submit">
						<input type="hidden" name="approve" value="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['preview']->value);?>
">
						<input type="submit" class="btn btn-default btn-sm" name="flaggedrev" value="Approuver la Version">
					</div>
				<?php }?>
			</form>
		<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_remarksbox(array('type'=>'comment','title'=>"Approbation du Contenu"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
        ...
        <?php if ((isset($_smarty_tpl->tpl_vars['flaggedrev_approval']->value)&&$_smarty_tpl->tpl_vars['flaggedrev_approval']->value)) {?>
            <?php $_smarty_tpl->smarty->_tag_stack[] = array('remarksbox', array('type'=>'warning','title'=>"History view")); $_block_repeat=true; echo smarty_block_remarksbox(array('type'=>'warning','title'=>"History view"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
                ...
                <p>
                    ...
                    <?php } else { ?>
                            Cette révision n'a pas été approuvée.
                    <?php }?>
                </p>
...
<?php if ($_smarty_tpl->tpl_vars['source']->value) {?>
	<h2>
		Source de la version: <?php echo $_smarty_tpl->tpl_vars['source']->value;?>

		<?php if ($_smarty_tpl->tpl_vars['info']->value['version']==$_smarty_tpl->tpl_vars['source']->value) {?><small><small>(courant)</small></small><?php }?>
	</h2>
...
<?php if (!isset($_smarty_tpl->tpl_vars['noHistory']->value)) {?>
	...
	<?php }?>
	<form id="pagehistory" class="form-horizontal confirm-form" action="tiki-pagehistory.php?page=<?php echo $_smarty_tpl->tpl_vars['page']->value;?>
">
...
">
		<div class="clearfix">
			<div class="pull-left col-sm-9" style="margin-bottom: 10px">
				...
				<label for="paginate">Activer la pagination</label>
...
" class="form-control" style="width: 5em; display: inline-block">
					<label for="history_pagesize">par page</label>
				<?php }?>
			</div>
				...
				<div class="col-sm-6 pull-left margin-bottom-sm">
					<div class="input-group input-group-sm">
						<span class="input-group-addon">
							<?php echo smarty_function_icon(array('name'=>'admin_i18n','class'=>'tips','title'=>":Traduction"),$_smarty_tpl);?>
...
"<?php if ($_smarty_tpl->tpl_vars['lang']->value==$_smarty_tpl->tpl_vars['languages']->value[$_smarty_tpl->getVariable('smarty')->value['section']['ix']['index']]['value']) {?> selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['languages']->value[$_smarty_tpl->getVariable('smarty')->value['section']['ix']['index']]['name'];?>
						...
						<div class="input-group-btn">
							<input type="submit" class="btn btn-primary btn-sm" name="update_translation" value="Mettre à jour la traduction"/>
							<?php if ($_smarty_tpl->tpl_vars['show_translation_history']->value) {?>
								<input type="hidden" name="show_translation_history" value="1">
								<?php echo smarty_function_button(array('show_translation_history'=>0,'_text'=>"Cacher l'historique des traductions",'_auto_args'=>"*",'_class'=>"btn btn-default btn-sm"),$_smarty_tpl);?>

							<?php } else { ?>
								<?php echo smarty_function_button(array('show_translation_history'=>1,'_text'=>"Montrer l'historique des traductions",'_auto_args'=>"*",'_class'=>"btn btn-default btn-sm"),$_smarty_tpl);?>
				...
				<div class="input-group input-group-sm col-sm-4 pull-right" style="margin-bottom: 10px">
					<select class="form-control" name="diff_style" id="diff_style_all"<?php if ($_smarty_tpl->tpl_vars['prefs']->value['javascript_enabled']=="y") {?> style="display: none"<?php }?>>
						...
						<option value="sidediff-char" <?php if ($_smarty_tpl->tpl_vars['diff_style']->value=="sidediff-char") {?>selected="selected"<?php }?>>
							Diff. côte à côte sur les caractères
						</option>
						...
						<option value="inlinediff-full-char" <?php if ($_smarty_tpl->tpl_vars['diff_style']->value=="inlinediff-full-char") {?>selected="selected"<?php }?>>
							Diff. entrelacée complète sur les caractères
						</option>
					...
					<?php if ($_smarty_tpl->tpl_vars['prefs']->value['javascript_enabled']=="y") {?>
						<span class="input-group-btn">
							<?php echo smarty_function_button(array('_text'=>"Avancé",'_id'=>"toggle_diffs",'_ajax'=>"n",'_class'=>"btn btn-default btn-sm"),$_smarty_tpl);?>
			...
			<div class="<?php if ($_smarty_tpl->tpl_vars['js']->value==='y') {?>table-responsive<?php }?>"> 
				<table class="table table-condensed table-hover table-striped">
					<tr>
						...
						<?php if ($_smarty_tpl->tpl_vars['prefs']->value['default_wiki_diff_style']!="old"&&$_smarty_tpl->tpl_vars['history']->value) {?>
							<th colspan="2">
								<input type="submit" class="btn btn-default btn-sm" name="compare" value="Comparer">
							</th>
						<?php }?>
					</tr>
					<tr class="active">
...
from %0<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_tr(array('_0'=>$_smarty_tpl->tpl_vars['info']->value['ip']), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);
								...
								<?php if ((isset($_smarty_tpl->tpl_vars['flaggedrev_approval']->value)&&$_smarty_tpl->tpl_vars['flaggedrev_approval']->value)&&$_smarty_tpl->tpl_vars['tiki_p_wiki_view_latest']->value=='y'&&$_smarty_tpl->tpl_vars['info']->value['approved']) {?><strong>(approuvé)</strong><?php }?>
...
<br>En cours<?php if ($_smarty_tpl->tpl_vars['current']->value==$_smarty_tpl->tpl_vars['info']->value['version']) {?></strong>
								<?php }?>
							</td>
							<td class="button_container">
...
Afficher<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_self_link(array('page'=>$_smarty_tpl->tpl_vars['page']->value,'preview'=>$_smarty_tpl->tpl_vars['info']->value['version'],'_icon_name'=>"view",'_menu_text'=>'y','_menu_icon'=>'y'), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);
...
echo smarty_function_popup(array('fullhtml'=>"1",'center'=>true,'text'=>smarty_modifier_escape(smarty_modifier_escape(Smarty::$_smarty_vars['capture']['current_actions'],"javascript"),"html")),$_smarty_tpl);
							...
							<?php if ($_smarty_tpl->tpl_vars['prefs']->value['default_wiki_diff_style']!="old"&&$_smarty_tpl->tpl_vars['history']->value) {?>
								<td class="button_container">
									<input type="radio" name="oldver" value="0" title="Comparer" <?php if (isset($_smarty_tpl->tpl_vars['old']->value['version'])&&$_smarty_tpl->tpl_vars['old']->value['version']==$_smarty_tpl->tpl_vars['info']->value['version']) {?>checked="checked"<?php }?>>
								</td>
								<td class="button_container">
									<input type="radio" name="newver" value="0" title="Comparer" <?php if ((isset($_smarty_tpl->tpl_vars['new']->value['version'])&&$_smarty_tpl->tpl_vars['new']->value['version']==$_smarty_tpl->tpl_vars['info']->value['version'])||(!isset($_REQUEST['diff_style'])||!$_REQUEST['diff_style'])) {?>checked="checked"<?php }?>>
								</td>
							<?php }?>
						<?php }?>
					</tr>
...
from %0<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_tr(array('_0'=>$_smarty_tpl->tpl_vars['element']->value['ip']), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);
								...
								<?php if ((isset($_smarty_tpl->tpl_vars['flaggedrev_approval']->value)&&$_smarty_tpl->tpl_vars['flaggedrev_approval']->value)&&$_smarty_tpl->tpl_vars['tiki_p_wiki_view_latest']->value=='y'&&$_smarty_tpl->tpl_vars['element']->value['approved']) {?><strong>(approuvé)</strong><?php }?>
...
"
											title="Version plus ancienne" <?php if ((isset($_smarty_tpl->tpl_vars['old']->value['version'])&&isset($_smarty_tpl->tpl_vars['element']->value['session'])&&$_smarty_tpl->tpl_vars['old']->value['version']==$_smarty_tpl->tpl_vars['element']->value['session'])||((!isset($_REQUEST['diff_style'])||!$_REQUEST['diff_style'])&&$_smarty_tpl->getVariable('smarty')->value['foreach']['hist']['first'])) {?>checked="checked"<?php }?>>
									<?php } else { ?>
										<input type="radio" name="oldver" value="<?php echo $_smarty_tpl->tpl_vars['element']->value['version'];?>
"
											title="Version plus ancienne" <?php if ((isset($_smarty_tpl->tpl_vars['old']->value['version'])&&isset($_smarty_tpl->tpl_vars['element']->value['version'])&&$_smarty_tpl->tpl_vars['old']->value['version']==$_smarty_tpl->tpl_vars['element']->value['version'])||((!isset($_REQUEST['diff_style'])||!$_REQUEST['diff_style'])&&$_smarty_tpl->getVariable('smarty')->value['foreach']['hist']['first'])) {?>checked="checked"<?php }?>>
									<?php }?>
								</td>
								<td class="button_container">
