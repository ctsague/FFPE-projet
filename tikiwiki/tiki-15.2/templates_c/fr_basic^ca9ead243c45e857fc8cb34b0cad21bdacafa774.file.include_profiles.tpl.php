<?php /* Smarty version Smarty-3.1.21, created on 2016-11-30 10:42:50
         compiled from "/home/ctsague/exos/projet_ffpe/tikiwiki/tiki-15.2/templates/admin/include_profiles.tpl" */ ?>
<?php /*%%SmartyHeaderCode:906049753583ead2a908892-95232936%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ca9ead243c45e857fc8cb34b0cad21bdacafa774' => 
    array (
      0 => '/home/ctsague/exos/projet_ffpe/tikiwiki/tiki-15.2/templates/admin/include_profiles.tpl',
      1 => 1460908603,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '906049753583ead2a908892-95232936',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_583ead2aca0196_57538579',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_583ead2aca0196_57538579')) {function content_583ead2aca0196_57538579($_smarty_tpl) {?><?php if (!is_callable('smarty_block_jq')) include '/home/ctsague/exos/projet_ffpe/tikiwiki/tiki-15.2/lib/smarty_tiki/block.jq.php';
...
';
		...
		function showDetails( id, domain, profile ) { // {{{
			...
			infoOb.innerHTML = " Chargement du profil...";
			...
			req.onreadystatechange = function (aEvt) {
				...
				if (req.readyState == 4) {
					if(req.status == 200) {
						...
						if( data.installable || data.already ) {
							...
							if( data.installable ) {
								...
								form.setAttribute ( "onsubmit", 'return confirm(\"Etes-vous sûr de vouloir appliquer ce profil ' + profile + '?\");' );
								submit.setAttribute ( "class", "btn btn-primary");
							} else if ( data.already ) {
								submit.name = 'forget';
								submit.value = 'Forget and Re-apply';
								form.setAttribute ( "onsubmit", 'return confirm(\"Etes-vous sûr de vouloir appliquer à nouveau le profil ' + profile + '?\");' );
								submit.setAttribute ( "class", "btn btn-primary");
							}
					...
					switch (req.readyState) {
						...
						case 2: {
							infoOb.innerHTML = " Envoi......";
							break;
						}
						case 3: {
							infoOb.innerHTML = " En attente...";
							break;
						}
					}
...
<?php if (isset($_smarty_tpl->tpl_vars['profilefeedback']->value)) {?>
	<?php $_smarty_tpl->smarty->_tag_stack[] = array('remarksbox', array('type'=>"note",'title'=>"Remarque")); $_block_repeat=true; echo smarty_block_remarksbox(array('type'=>"note",'title'=>"Remarque"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
		...
		La liste suivante de changement a été appliquée:
		<ul>
...
<?php $_smarty_tpl->smarty->_tag_stack[] = array('tabset', array('name'=>'tabs_admin-profiles')); $_block_repeat=true; echo smarty_block_tabset(array('name'=>'tabs_admin-profiles'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
	...
	<?php $_smarty_tpl->smarty->_tag_stack[] = array('tab', array('name'=>"Appliquer")); $_block_repeat=true; echo smarty_block_tab(array('name'=>"Appliquer"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
		...
		<?php if ($_smarty_tpl->tpl_vars['prefs']->value['javascript_enabled']=='y') {?>
			<?php if ($_smarty_tpl->tpl_vars['openSources']->value=='some') {?>
				<?php $_smarty_tpl->smarty->_tag_stack[] = array('remarksbox', array('type'=>"warning",'title'=>"Avertissement")); $_block_repeat=true; echo smarty_block_remarksbox(array('type'=>"warning",'title'=>"Avertissement"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
					...
					Quelques uns de vos dépôts de profils ne répondent pas. Ceci pourrait empêcher d'appliquer certains profils
				...
				<div class="row">
					<div class="col-sm-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" name="profile" placeholder="Trouver..." id="profile" value="<?php if (isset($_smarty_tpl->tpl_vars['profile']->value)) {
...
"<?php if (isset($_smarty_tpl->tpl_vars['repository']->value)&&$_smarty_tpl->tpl_vars['repository']->value==$_smarty_tpl->tpl_vars['source']->value['url']) {?> selected="selected"<?php }?>><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['source']->value['short']);?>
						...
						<div class="form-group text-center">
							<input type="submit" class="btn btn-primary" name="list" value="Trouver" />
						</div>
					</div>
					<div class="col-sm-6">
...
echo $_smarty_tpl->tpl_vars['profilesFilterUrlEnd']->value;?>
" class="alert-link">Profils complets</a>
									<br>Les profils complets sont des solutions clés en mains aux nombreuses fonctionnalités.
								</p>
...
echo $_smarty_tpl->tpl_vars['profilesFilterUrlEnd']->value;?>
" class="alert-link">Profils minimums</a>
									<br>Les profils minimums vont configurer des fonctionnalités spécifiques et sont une excellente voie pour enrichir une  configuration existante.
								</p>
...
echo $_smarty_tpl->tpl_vars['profilesFilterUrlEnd']->value;?>
" class="alert-link">Profils d'apprentissage</a>
									<br>Les profils d'apprentissage permettent d'évaluer rapidement des fonctionnalités particulières dans Tiki.
								</p>
...
' )"><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['profile']->value['name']);?>
</a><?php if ($_smarty_tpl->tpl_vars['profile']->value['installed']) {?> <em>appliquer</em><?php }?></td>
								<?php }?>
						...
						<?php if (count($_smarty_tpl->tpl_vars['result']->value)=='0') {?>
							<tr><td colspan="3" class="odd">Aucun</td></tr>
						<?php }?>
					</table>
					<?php if ($_smarty_tpl->tpl_vars['show_details_for_profile_num']->value!='') {?>
						<?php $_smarty_tpl->smarty->_tag_stack[] = array('jq', array()); $_block_repeat=true; echo smarty_block_jq(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
');<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_jq(array(), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
		...
		<?php } else { ?>
			<?php $_smarty_tpl->smarty->_tag_stack[] = array('remarksbox', array('type'=>"warning",'title'=>"Avertissement")); $_block_repeat=true; echo smarty_block_remarksbox(array('type'=>"warning",'title'=>"Avertissement"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
				...
				Javascript doit être positionné sur <b>ON</b> pour pouvoir appliquer les Profils. Merci d'activer Javascript et de réessayer ensuite.
			<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_remarksbox(array('type'=>"warning",'title'=>"Avertissement"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>

		<?php }?>
	<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_tab(array('name'=>"Appliquer"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>


	<?php $_smarty_tpl->smarty->_tag_stack[] = array('tab', array('name'=>"Exporter")); $_block_repeat=true; echo smarty_block_tab(array('name'=>"Exporter"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
">
			<fieldset id="export_to_yaml">
				...
				<fieldset>
					<legend>Exporter les préférences modifiées en YAML</legend>
					<div class="t_navbar">
						...
						<label for="export_show_added">Afficher les préférences ajoutées</label>
...
">
 ...
 :
					...
					<div class="text-center submit input_submit_container">
						<input type="submit" class="btn btn-primary" name="export" value="Exporter" />
					</div>
				</fieldset>
			</fieldset>
		</form>
	<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_tab(array('name'=>"Exporter"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
">
							<?php if ($_smarty_tpl->tpl_vars['entry']->value['status']=='open') {?>
								<?php echo smarty_function_icon(array('name'=>'status-open','iclass'=>'tips','ititle'=>"État:Ouvert"),$_smarty_tpl);?>

								<?php echo smarty_function_icon(array('name'=>'status-pending','istyle'=>'display:none','iclass'=>'tips','ititle'=>"État:En attente"),$_smarty_tpl);?>

								<?php echo smarty_function_icon(array('name'=>'status-closed','istyle'=>'display:none','iclass'=>'tips','ititle'=>"État:Fermé"),$_smarty_tpl);?>

							<?php } elseif ($_smarty_tpl->tpl_vars['entry']->value['status']=='closed') {?>
								<?php echo smarty_function_icon(array('name'=>'status-open','istyle'=>'display:none','iclass'=>'tips','ititle'=>"État:Ouvert"),$_smarty_tpl);?>

								<?php echo smarty_function_icon(array('name'=>'status-pending','istyle'=>'display:none','iclass'=>'tips','ititle'=>"État:En attente"),$_smarty_tpl);?>

								<?php echo smarty_function_icon(array('name'=>'status-closed','iclass'=>'tips','ititle'=>"État:Fermé"),$_smarty_tpl);?>

							<?php } else { ?>
								<?php echo smarty_function_icon(array('name'=>'status-open','istyle'=>'display:none','iclass'=>'tips','ititle'=>"État:Ouvert"),$_smarty_tpl);?>

								<?php echo smarty_function_icon(array('name'=>'status-pending','iclass'=>'tips','ititle'=>"État:En attente"),$_smarty_tpl);?>
...
)" title="Actualiser"><?php echo smarty_function_icon(array('name'=>"refresh",'iclass'=>'tips','ititle'=>":Actualiser"),$_smarty_tpl);?>
</a></td>
					</tr>
				<?php } ?>
			</table>
...
">
				...
				<div class="text-center submit">
					<input type="submit" class="btn btn-primary" name="config" value="Enregistrer" />
				</div>
			</form>
		</fieldset>
		<fieldset><legend>Testeur de profil</legend>
			<form class="form-horizontal" action="tiki-admin.php?page=profiles" method="post">
				<input type="hidden" name="ticket" value="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['ticket']->value);?>
">
				<?php $_smarty_tpl->smarty->_tag_stack[] = array('remarksbox', array('type'=>"warning",'title'=>"Avertissement")); $_block_repeat=true; echo smarty_block_remarksbox(array('type'=>"warning",'title'=>"Avertissement"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
					...
					<em><strong>Ceci va exécuter le profil et rendre potentiellement irrécupérables les changements dans votre base de données!</strong></em>
				<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_remarksbox(array('type'=>"warning",'title'=>"Avertissement"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
echo $_smarty_tpl->tpl_vars['profile_tester_name']->value;
						...
						<div class="col-sm-4">
							...
							<option value=""<?php if (isset($_smarty_tpl->tpl_vars['empty_cache']->value)&&$_smarty_tpl->tpl_vars['empty_cache']->value=='') {?> checked="checked"<?php }?>>Aucun</option>
							<option value="all"<?php if (isset($_smarty_tpl->tpl_vars['empty_cache']->value)&&$_smarty_tpl->tpl_vars['empty_cache']->value=='all') {?> checked="checked"<?php }?>>Tous</option>
...
echo $_smarty_tpl->tpl_vars['test_source']->value;
				...
				<div align="center" style="padding:1em;"><input type="submit" class="btn btn-default" name="test" value="Test" /></div>
			</form>
		</fieldset>
