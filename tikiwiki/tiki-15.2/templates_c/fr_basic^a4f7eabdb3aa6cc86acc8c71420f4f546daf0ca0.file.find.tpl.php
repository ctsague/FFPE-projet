<?php /* Smarty version Smarty-3.1.21, created on 2016-11-30 10:50:33
         compiled from "/home/ctsague/exos/projet_ffpe/tikiwiki/tiki-15.2/templates/find.tpl" */ ?>
<?php /*%%SmartyHeaderCode:519700238583eaef9d067a5-35378338%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a4f7eabdb3aa6cc86acc8c71420f4f546daf0ca0' => 
    array (
      0 => '/home/ctsague/exos/projet_ffpe/tikiwiki/tiki-15.2/templates/find.tpl',
      1 => 1458711827,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '519700238583eaef9d067a5-35378338',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_583eaefa1cb939_60730766',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_583eaefa1cb939_60730766')) {function content_583eaefa1cb939_60730766($_smarty_tpl) {?><?php if (!is_callable('smarty_function_query')) include '/home/ctsague/exos/projet_ffpe/tikiwiki/tiki-15.2/lib/smarty_tiki/function.query.php';
...
if (!is_callable('smarty_function_html_select_duration')) include '/home/ctsague/exos/projet_ffpe/tikiwiki/tiki-15.2/lib/smarty_tiki/function.html_select_duration.php';
?>
...
" placeholder="<?php if (empty($_smarty_tpl->tpl_vars['whatlabel']->value)) {?>Trouver...<?php } else {
...
")<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_jq(array(), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
				...
				<div class="input-group-btn">
					<button type="submit" class="btn btn-default" name="search">Trouver</button>
				</div>
			</div>
...
?<?php echo smarty_function_query(array('find'=>'','type'=>'','types'=>'','topic'=>'','lang'=>'','langOrphan'=>'','exact_match'=>'','categId'=>'','maxRecords'=>$_smarty_tpl->tpl_vars['prefs']->value['maxRecords'],'find_from_Month'=>'','find_from_Day'=>'','find_from_Year'=>'','find_to_Month'=>'','find_to_Day'=>'','find_to_Year'=>''),$_smarty_tpl);?>
" title="Vider le filtre" class="btn btn-link">Vider le filtre</a>
				</div>
			<?php }?>
		</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<select name="type" class="findtypes form-control input-sm">
							<option value='' <?php if ($_smarty_tpl->tpl_vars['find_type']->value=='') {?>selected="selected"<?php }?>>tout type</option>
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<select name="topic" class="findtopics form-control input-sm">
							<option value='' <?php if ($_smarty_tpl->tpl_vars['find_topic']->value=='') {?>selected="selected"<?php }?>>n'importe quel sujet</option>
					...
					<div class="col-sm-8">
						<span class="findlang">
							<select name="lang" class="in form-control input-sm">
								<option value='' <?php if ($_smarty_tpl->tpl_vars['find_lang']->value=='') {?>selected="selected"<?php }?>>n'importe quelle langue</option>
					...
					<?php if ($_smarty_tpl->tpl_vars['find_show_categories_multi']->value=='n'||$_smarty_tpl->tpl_vars['findSelectedCategoriesNumber']->value<=1) {?>
						...
						<div id="category_singleselect_find" class="col-sm-8">
							<select name="categId" class="findcateg form-control input-sm">
								<option value='' <?php if ($_smarty_tpl->tpl_vars['find_categId']->value=='') {?>selected="selected"<?php }?>>toutes catégories</option>
									...
									<?php if ($_smarty_tpl->tpl_vars['tiki_p_admin_categories']->value=='y') {?>
										<div class="pull-right">
											<a href="tiki-admin_categories.php" class="link">
												Administrer les catégories <?php echo smarty_function_icon(array('name'=>'wrench'),$_smarty_tpl);?>
